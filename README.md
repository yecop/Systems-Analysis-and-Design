...
* `/assets/`: System architecture diagrams, flowcharts, and ISO 31000 risk matrices.
...
* `/docs/`: Comprehensive project documentation, structured by deliverables (`Workshop_1_analysis`, `Workshop_2_Design`, `Workshop3_Management`, `Workshop_4_Simulation`, `Catch-Up`, and `Final_Delivery`).
* `/experiments/`: Exploratory tests and experimental configurations.
* `/references/`: Academic literature and bibliographic resources.
* `/results/`: Processed outputs and synthetic telemetry generated by simulations.
* `/src/`: Autonomous telemetry agent source code for production.
...
* [Discrete-Event Simulator Source Code](./src/)
* [Synthetic Telemetry Dataset](./results/simulation_results.csv)
* [System Simulation Report](./docs/Workshop_4_Simulation/)
...
* **[Comprehensive Final Technical Report (PDF & LaTeX)](./docs/Final_Delivery/)**
